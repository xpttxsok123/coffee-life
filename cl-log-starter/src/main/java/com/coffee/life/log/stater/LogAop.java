package com.coffee.life.log.stater;
...
import com.coffee.life.utils.XcOauth2Util;
...
public class LogAop {
     ...
     */
    @Around(value = "@annotation(com.coffee.life.log.stater.annotation.LogAnnotation)")
